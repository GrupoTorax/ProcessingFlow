...
import org.torax.commons.Point;
import org.torax.orchestration.StructureType;
import org.torax.pdi.BinaryLabelingProcess;
import org.torax.pdi.BinaryLabelingProcess.ExtractedObject;
...
public class SegmentAorta {
    ...
    private void segmentSlice(int sliceIndex) {
        ...
        limit.process();
        // Binarizes the image
        image = ImageHelper.create(limit.getOutput(), new org.torax.commons.Range<>(0, 1));
